...
<html lang="en" dir="ltr">
	...
	<body>
		<nav class="navbar navbar-expand-lg navbar-animated">
		  <a class="navbar-brand" href="dashboard"><i class="fa fa-hand-spock"></i> SPA MANAGEMENT SYSTEM</a>
		    ...
		    <ul class="navbar-nav mr-right">
		      ...
		      <li class="nav-item">
		        ...
		        <a class="nav-link text-center" href="sections"><i class="fa fa-box"></i><br>SECTIONS</a>
					...
					<li class="nav-item">
		        <a class="nav-link text-center" href="categories"><i class="fa fa-box"></i><br>CATEGORIES</a>
		      </li>
					<li class="nav-item">
		        <a class="nav-link text-center" href="equipments"><i class="fa fa-cube"></i><br>EQUIPMENTS</a>
		      </li>
					<li class="nav-item">
		      ...
		      <li class="nav-item">
		        <a class="nav-link text-center" href="settings"><i class="fa fa-cog"></i><br>SETTINGS</a>
					...
					<li class="nav-item">
		        <a class="nav-link text-center" href="auth/logout"><i class="fa fa-sign-out-alt"></i><br>LOGOUT</a>
		      </li>
		    </ul>
		  </div>
		</nav>
